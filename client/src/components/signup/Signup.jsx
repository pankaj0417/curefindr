...
const Signup = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white dark:bg-green-950 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition duration-300">
        {/* Alerts */}
        {errorMsg && (
